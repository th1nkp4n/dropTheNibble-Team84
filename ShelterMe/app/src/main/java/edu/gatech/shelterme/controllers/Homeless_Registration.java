...
//                                        return;
//                                    }
                                    Homeless.setAge(Integer.valueOf(ageField.getText().toString()), key);
                                    Homeless.setGender((String) genderSpinner.getSelectedItem(), key);
                                    Homeless.setVeteran((boolean) veteranSpinner.getSelectedItem(), key);
                                }
